...
<div class="container-full">
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h3 class="page-title">Merchants</h3>
            ...
            @can('create merchant')
            <a class="btn btn-primary" href="{{ route('merchant.create') }}">Add Merchant</a>
            @endcan
        </div>
    </div>
</div>
                        ...
                        <table class="table border-no" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr class="hover-primary">
                                    ...
                                    <td><span class="badge badge-primary">{{ $value->sandbox == 0 ? 'Production' : 'Sandbox' }}</span></td>
                                    <td>
                                        <div class="d-flex">
                                            @can('edit merchant')
                                            <a href="{{ route('merchant.edit', $value->id) }}" class="btn btn-sm btn-primary me-1"><i class="fa-solid fa-pen-to-square"></i></a>
                                            @endcan
                                            @can('delete merchant')
